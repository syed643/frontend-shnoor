      ...
      <div className="flex items-center justify-center min-h-screen bg-slate-100 font-sans">
        <div className="bg-white p-10 rounded-xl shadow-lg border border-slate-200 text-center max-w-lg w-full">
          ...
          <p className="text-slate-500 mb-8 leading-relaxed">
            This is a secured assessment.
            Full-screen mode will be enabled, and tab switching is monitored.
          </p>
          <div className="p-4 bg-amber-50 border border-amber-100 rounded-lg text-sm text-amber-800 mb-8 text-left space-y-2">
            <p className="font-bold flex items-center gap-2"><FaTimesCircle /> Security Rules:</p>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        >
          {currentQ.type === "descriptive" ? (
            ...
            <div className="flex flex-col h-full w-full">
              <div className={`flex-1 overflow-hidden relative ${isExamLocked || isSubmitted ? "opacity-60 pointer-events-none" : ""}`}>
                <PracticeSession
                  question={currentQ}
                  value={answers[questionId]}
                  onChange={(val) => handleAnswer(questionId, val)}
